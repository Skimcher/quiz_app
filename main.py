...
CHARACTERS = [
    {
        "id": 1,
        "poem": (
            "Кепка набок, взгляд орлиный,/n"
Спорт и стать — мужчина видный./n"
Каждый день он на зарядке —/n"
Угадай без всякой загадки!"
    ...
    },
    {
        "id": 2,
        "poem": (
            "Она урок ведёт с улыбкой,/n"
Характер добрый, не ошибка./n"
Джони — пёс её родной —/n"
